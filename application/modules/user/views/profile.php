			...
			<div class="col-md-3">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Detalle del Contacto</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<strong><i class="fa fa-building margin-r-5"></i> Nombre de la Compañia</strong>
			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#activity" data-toggle="tab">Detalles de Trabajo</a></li>
					</ul>
						...
						<div class="active tab-pane" id="activity">
							...
							<div class="post">
								<div class="user-block">
									<h4 class="text-green">Naturaleza del Trabajo<a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a></h4>
								</div>
								<!-- /.user-block -->
								<p></p>
							</div>
							<div class="post">
								<div class="user-block">
									<h4 class="text-green">Número de Registro de la Compañia<a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a></h4>
								</div>
								<!-- /.user-block -->
								<p></p>
							</div>
